...
def get_jobs(keyword, num_jobs, verbose,path,slp_time):
    ...
    job_buttons = driver.find_elements('class_name',"jl")  #jl for Job Listing. These are the buttons we're going to click.
    for job_button in job_buttons:  
        ...
        try:
            salary_estimate = driver.find_element('xpath','.//span[@class="graysalary"]').text
        except NoSuchElementException:
